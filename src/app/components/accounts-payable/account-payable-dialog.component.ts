  ...
  template: `
    <div class="dialog-container">
      <div class="dialog-header">
        <h2>{{ data ? 'Editar Conta a Pagar' : 'Nova Conta a Pagar' }}</h2>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()">
        <div class="dialog-content">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <textarea matInput formControlName="notes" rows="2" placeholder="Observações adicionais"></textarea>
          </mat-form-field>
        </div>
        ...
        <div class="dialog-footer">
          ...
          <button mat-raised-button color="primary" type="submit" [disabled]="form.invalid || loading">
            ...
            <span *ngIf="!loading">{{ data ? 'Salvar' : 'Criar Despesa' }}</span>
          </button>
        </div>
      </form>
    </div>
...
export class AccountPayableDialogComponent implements OnInit {
  form: FormGroup;
  loading = false;

  constructor(
    private fb: FormBuilder,
    private dialogRef: MatDialogRef<AccountPayableDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: AccountPayable | null
  ) {
